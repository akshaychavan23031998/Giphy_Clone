  ...
  return (
    <div className='flex flex-col sm:flex-row gap-5 my-4'>
      ...
      <div>
        ...
        <h2 className='text-lg text-gray-400 pb-3 font-bold hover:text-gray-50 cursor-pointer'>@{category} GIFs</h2>
        {results.length > 0 && (
          <div className='columns-2 md:columns-3 lg:columns-4 lg:columns-5 gap-2'>
